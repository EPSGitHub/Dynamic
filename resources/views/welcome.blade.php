...
<!-- Mirrored from eps.com.bd/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jan 2022 03:54:45 GMT -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-5 col-lg-6">
                    ...
                    <div class="welcome-thumb text-center" data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000">
                        <img src="asset{{('images/welcome-mockup-2.png')}}" alt="">
                    </div>
                    <!-- Video Icon -->
                ...
                <!-- Benifits Item -->
                    ...
                    <div class="benifits-item text-center p-3">
                        <div class="feature-icon">
                            <img src="{{asset('images/1640852164.png')}}" alt="">
                        </div>
                        <!-- Benifits Text -->
                    ...
                    <div class="benifits-item text-center p-3">
                        <div class="feature-icon">
                            <img src="{{asset('images/1640852391.png')}}" alt="">
                        </div>
                        <!-- Benifits Text -->
                        <div class="benifits-text">
                    ...
                    <div class="benifits-item text-center p-3">
                        <div class="feature-icon">
                            <img src="asset{{('images/1640852623.png')}}" alt="">
                        </div>
                        <!-- Benifits Text -->
                        <div class="benifits-text">
...
services.</p>
                    ...
                    <div class="benifits-item text-center p-3">
                        <div class="feature-icon">
                            <img src="asset{{('images/1640852907.png')}}" alt="">
                        </div>
                        <!-- Benifits Text -->
                        <div class="benifits-text">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="about-thumb text-center d-none d-lg-block">
                        <img src="{{asset('images/1641362531.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items">
                        ...
                        <div class="social-icons d-flex">
                            ...
                            <a class="twitter" href="https://twitter.com/EpsPay" target="_blank">
                                <i class="fab fa-twitter"></i>
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a class="google-plus" href="https://www.linkedin.com/company/epspay/" target="_blank">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items">
                        ...
                        <ul>
                            ...
                            <li class="py-2"><a class="text-white-50" href="service-details.html">Service Details</a></li>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items">
                        ...
                        <ul>
                            <li class="py-2"><a class="text-white-50" href="ios-app-support.html">For IOS</a></li>
                            <li class="py-2"><a class="text-white-50" href="android-app-support.html">For Android</a></li>
                        </ul>
                    </div>
                </div>
            </div>
